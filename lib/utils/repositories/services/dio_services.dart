...
import 'package:flutter_template/utils/consts/services/api_constants.dart';
import 'package:flutter_template/utils/helpers/jwt_token_helper.dart';
import 'package:flutter_template/utils/repositories/exceptions/service_exception.dart';

class ApiBaseCore {
  late Dio baseAPI;

  final BaseOptions opts = BaseOptions(
    baseUrl: MyApiConstant.getBaseUrl(),
  ...
  Future<void> requestInterceptor(
    ...
    String token = "";
    final jwtTokenHelper = MyJwtTokenHelper();
    ...
    if (await jwtTokenHelper.existJwtToken()) {
      if (!await jwtTokenHelper.isValidAccessToken()) {
        ...
        Response<dynamic> response = await dio.post(
          MyApiConstant.refreshTokenPath,
          data: {
